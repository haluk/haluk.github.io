...
\name{Haluk Dogan}
\info{
  \faicon{map-marker} & 10900 Wittenridge Dr Lot H3, Alpharetta, GA, 30022\\
  \faicon{phone}      & \href{tel:14044218408}{+1 404-421-8408}\\
  \faicon{envelope}   & \href{mailto:hdogan@vivaldi.net}{hdogan@vivaldi.net}\\
  \faicon{home}       & \url{https://haluk.github.io}\\
  \faicon{github}     & \url{https://github.com/haluk}
}
...
\begin{longtable}{p{7cm}p{7cm}p{6cm}}
  ...
  \ding{228} \textbf{Machine Learning Scientist} & \textbf{University of Nebraska-Lincoln, NE, USA} & \textbf{Aug 2013 -- May 2021}\\
  \parbox{18cm} {
  \begin{itemize}[topsep=0.2cm]
