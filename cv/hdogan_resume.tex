...
\begin{longtable}{p{6cm}p{8cm}p{6cm}}
  ...
  \begin{itemize}[topsep=0.2cm]
    ...
    \begin{itemize}[topsep=-0.2cm]
      ...
      \item Machine Learning Libraries: Numpy, Scipy, Scikit-learn, pyAgrum, Orange
  ...
  \parbox{18cm}{
    \begin{itemize}[topsep=0.2cm]
      \item Lead recitation/lab hours for ``Introduction to Programming'', ``Probability and Statistics'', ``Bioinformatics'' courses
